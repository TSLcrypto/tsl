...
const MAIN_POOL = "0x46d776A2F759718A9F86642f52a7FBb2B475b22F";
...
async function main() {
  console.log("TokenOne full indexer check - read only");
  ...
  section("Next Signal");
  console.log("Moralis target: logo/thumbnail should change from null to a URL.");
